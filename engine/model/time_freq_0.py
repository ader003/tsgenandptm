...
class TimeFreqEncoder(nn.Module):
    def __init__(self, encoder,
        ...
        self.in_dim = self.encoder_t.in_dim
    ...
    def expand_dim(self, in_dim_new):
        self.encoder_t.expand_dim(in_dim_new)
        self.encoder_f.expand_dim(in_dim_new)
        self.in_dim = self.encoder_t.in_dim

    def expand_dim_cp(self, in_dim_new):
        self.encoder_t.expand_dim_cp(in_dim_new)
        self.encoder_f.expand_dim_cp(in_dim_new)
        self.in_dim = self.encoder_t.in_dim
